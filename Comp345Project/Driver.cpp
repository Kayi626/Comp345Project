...
#pragma region OrderList
    ...
    Orders* o1 = new DeployOrder(5, &t2);
    Orders* o2 = new DeployOrder(30, &t3);
    Orders* o3 = new AdvanceOrder(10, &t3, &t2);
    Orders* o4 = new BombOrder(&t4);
    Orders* o5 = new BlockadeOrder(&t2);
    Orders* o6 = new AirliftOrder(7, &t3, &t2);
    Orders* o7 = new NegotiateOrder();
