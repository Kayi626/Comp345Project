...
vector<string>* Card::get_pointer_type_arr() {
...
void Card::set_card_type_id(int id) {
	card_type = &vec_types_card.at(id);
}
...
void Deck::print_vec_size_of_deck() {
	cout << (" The current vec_deck are: ") << vec_deck.size() << endl;
}
...
void Deck::return_card_into_deck_vec(Card* card) {
	vec_deck.push_back(card);
}
...
vector<Card*>* Hand::get_vec_hand_cards() {
